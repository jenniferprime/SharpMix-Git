...
namespace SharpMix.Common.Module.MappedActions
{
    public class PremappedActions
    {
        ...
        public static void MapPremappedActions()
        {
            ...
            preMappedActions.Add("A:Audio:Pulse:Output:MasterVolume", new MappedFader(0, pulseDevice, MappedTypeFader.PulseDeviceVolume));
            preMappedActions.Add("A:Audio:Pulse:Output:MasterMute", new MappedToggle(0, pulseDevice, MappedTypeToggle.PulseDeviceMute));
